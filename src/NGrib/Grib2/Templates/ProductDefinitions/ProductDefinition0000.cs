...
namespace NGrib.Grib2.Templates.ProductDefinitions
{
	...
	/// </summary>
	public class ProductDefinition0000 : WithBackgroundProductDefinition, ILeveledProductDefinition
	{
		/// <summary>
		...
		/// <inheritdoc />>
		public override TimeRangeUnit TimeRangeUnit { get; }

		/// <inheritdoc />>
		public override int ForecastTime { get; }
